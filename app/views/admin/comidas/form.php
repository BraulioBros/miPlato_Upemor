...
<form method='POST' action='index.php?controller=admin&action=comidaSave'>
  ...
  <textarea class='form-control' name='descripcion' rows='3'><?= $c['descripcion'] ?? '' ?></textarea>

  <label class='form-label'>Kcal por 100g</label>
  <input class='form-control' type='number' step='0.01' min='0'
         name='calorias_por_100g'
         value='<?= $c['calorias_por_100g'] ?? '0' ?>' required>

  <label class='form-label'>Nutriente</label>
  <select class='form-control' name='id_nutriente'>
    <option value=''>-- Sin nutriente --</option>
